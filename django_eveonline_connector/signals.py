...
def eve_token_generate_default_token(sender, **kwargs):
    ...
    if EveTokenType.objects.all().count() == 0:
        token_type = EveTokenType.objects.create(name="Default Token Type", description="Generated by system")
        token_type.scopes.add(EveScope.objects.get_or_create(name="publicData")[0])
